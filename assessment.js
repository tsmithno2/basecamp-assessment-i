// #1 create a variable called 'myName' and assign it to your name as a string
 ...
 var myName = "Trevor Smith"; // CODE HERE
...
var trueFaveNum;
if (faveNum === trueFaveNum){trueFaveNum = true};// CODE HERE
...
console.log(notHakeem === myName);// CODE HERE
...
var responseCreator = function(param){
 if ("green"){console.log("Green is okay.")};
 else if ("red"){console.log("I heart red."};
 else {console.log("What is your faverite color?")};// CODE HERE
}
